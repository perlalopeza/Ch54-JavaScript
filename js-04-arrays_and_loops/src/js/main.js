...
/* const hacerLista = (listaDeCantantes) => {
    let lista = "";
    for (const cantante of listaDeCantantes) {
       lista += "<li>" + cantante + "</li>";
    }
    return lista;
}

const imprimirEnDom = (lista) => {
    document.getElementById("cantantes-lista").innerHTML = hacerLista(lista);
}
imprimirEnDom(hacerLista(cantantes));
 */
