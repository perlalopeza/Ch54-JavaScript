...
const ProductCard = () => {
    ...
    const handleIncrement = (maxValue) => {
        console.log("Estoy en el manejon de incremento");
        if (count < maxValue) setCount(count + 1);
        console.log("Valor de count: " + count);
    };

    const handleDecrement = (minValue) => {
        console.log("Estoy en el manejon de decremento");
    ...
    return (
        <div>
            <Typography sx={{color:"green"}} variant="h2" component="h4">tittle</Typography>
            <p>raiting</p>
            <p>price</p>
            <p>{count}</p>
